...
from local_llm.plugins import (
    UserPrompt, LaikaQuery, PrintStream,
...
class VoiceChat(Agent):
    ...
    def __init__(self, **kwargs):
        ...
        self.tts_output = RateLimit(kwargs['sample_rate_hz'],
                                    chunk=9600)  # slow down TTS to realtime and be able to pause it

        self.tts.add(self.tts_output)
        self.llm.add(self.tts, LaikaQuery.OutputWords)
    ...
    def asr_final(self, text):
        print(f"ASR final received {text}")
